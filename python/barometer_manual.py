...
class VisualFeedback(Node):
    ...
    def _initialize_thresholds(self):
            # Use simpledialog to get user input for initial thresholds
            green_threshold = self._get_threshold("Green threshold:")
            yellow_threshold = self._get_threshold("Yellow threshold:")
            orange_threshold = self._get_threshold("Orange threshold:")
            red_threshold = self._get_threshold("Red threshold:")

            self.initial_thresholds = [red_threshold, orange_threshold, yellow_threshold, green_threshold]
